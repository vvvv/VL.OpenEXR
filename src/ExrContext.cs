...
unsafe class ExrContext : SafeHandle
{
...
unsafe class ExrPart(ExrContext context, int partIndex)
{
...
record struct ExrChannel(int Index, string Name, exr_pixel_type_t PixelType)
{
    public string Layer
    {
        get
