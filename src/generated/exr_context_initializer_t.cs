...
{
    internal unsafe partial struct exr_context_initializer_t
    {
        [NativeTypeName("size_t")]
        public nuint size;

        [NativeTypeName("exr_error_handler_cb_t")]
        public delegate* unmanaged[Cdecl]<exr_context_t*, int, sbyte*, void> error_handler_fn;
        ...
        public delegate* unmanaged[Cdecl]<exr_context_t*, void*, void*, ulong, ulong, delegate* unmanaged[Cdecl]<exr_context_t*, int, sbyte*, int>, long> read_fn;

        [NativeTypeName("exr_query_size_func_ptr_t")]
        public delegate* unmanaged[Cdecl]<exr_context_t*, void*, long> size_fn;

        [NativeTypeName("exr_write_func_ptr_t")]
        public delegate* unmanaged[Cdecl]<exr_context_t*, void*, void*, ulong, ulong, delegate* unmanaged[Cdecl]<exr_context_t*, int, sbyte*, int>, long> write_fn;

        [NativeTypeName("exr_destroy_stream_func_ptr_t")]
        public delegate* unmanaged[Cdecl]<exr_context_t*, void*, int, void> destroy_fn;
